													...
													<div>
														<table class="table table-striped table-bordered">
															...
															<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
																	<td class="center news_id"><?php echo ($vo["id"]); ?></td>
																	<td class="hidden-xs"><?php echo ($vo["intro"]); ?></td>
																	<td><?php echo (date("Y-m-d H:i:s" , $vo["time"])); ?></td>
																	<td class="hidden-480"><a href="/shy/admin.php/Home/News/alert?id=<?php echo ($vo["id"]); ?>" class="news_alert"> 修改</a> 
																	| <a href="#"><span class="news_del">删除</span></a> | <a href="#"><span class="news_close">关闭</span></a>
																	</td>	
...
<script type="text/javascript">
	var news_del = "<?php echo U('News/newsdel');?>";
	var news_close = "<?php echo U('News/newsclose');?>";
	// var news_alert = "<?php echo U('News/alert');?>";
	var index  ="<?php echo U('News/index');?>";
</script>
