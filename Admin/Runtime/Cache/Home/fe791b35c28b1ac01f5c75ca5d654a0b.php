										...
										<div class="widget-box transparent invoice-box">
											...
											<div class="widget-body">
												<div class="widget-main padding-24">
															...
															<div>
																<ul class="list-unstyled  spaced">
																	<li>
																		...
																		<?php echo ($t); ?>
																		<?php switch($_GET['type']): case "1": ?>联系我们<?php break;?>
																			<?php case "2": ?>院长介绍<?php break;?>
																			<?php case "3": ?>书院介绍<?php break;?>
																			<?php case "4": ?>会员介绍<?php break; endswitch;?>
																	</li>
																</ul>
															</div>
														</div><!-- /span -->
													...
													<form action="<?php echo U('Content/alertSave');?>" method="post">
													<div>
