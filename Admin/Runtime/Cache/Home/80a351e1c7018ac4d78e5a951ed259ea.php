				...
				<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active"><a href=""></a>删除作品</li>
						</ul><!-- .breadcrumb -->
									...
									<ul class="ace-thumbnails">
										<?php if(is_array($list)): foreach($list as $key=>$vo): ?><li>
											<a href="#" data-rel="colorbox">
												<img style="width: 150px; height: 150px" alt="150x150" src="/shy/Uploads/<?php echo ($vo["address"]); ?>" />
												<div class="text">
													<div class="inner">删除</div>
												</div>
											</a>

											<div class="tools tools-bottom del_word">
												<a href="#" >
													<i style="display: none" class="del_id"><?php echo ($vo["id"]); ?></i>
													<i class="icon-pencil " ></i>
												</a>
											</div>
...
<![endif]-->
	...
	<div style="display:none"><script src='http://v7.cnzz.com/stat.php?id=155540&web_id=155540' language='JavaScript' charset='gb2312'></script></div>
		...
		<script type="text/javascript">
		$(function() {
			var url = "/shy/admin.php/Home/Word/del_word";
			var data = "id=" + $('.del_id').html();
