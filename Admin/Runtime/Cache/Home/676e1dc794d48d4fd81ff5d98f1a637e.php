												...
												<div class="widget-main padding-24">
													...
													<div>
														<table class="table table-striped table-bordered">
															<thead>
																<tr>
																	<th class="center">单页</th>
																	<th class="col-xs-6">简介</th>
																	<th >状态</th>
																	<th >操作</th>
																	<th >备注</th>
																</tr>
															...
															<tbody>
																<tr>
																	...
																	<td class="hidden-480"> <span class="alter"><a href="<?php echo U('Content/alert?type=1');?>">修改</a></span> </td>
																	<td></td>
																</tr>

																<tr>
																	<td class="center">院长介绍</td>
																	...
																	<td class="hidden-480"> <span class="alter"><a href="<?php echo U('Content/alert?type=2');?>">修改</a></span> </td>
																	<td></td>
																</tr>

																<tr>
																	<td class="center">书院介绍</td>
																	<td></td>
																	<td class="hidden-xs">
																		正常
																	</td>
																	<td class="hidden-480"> <span class="alter"><a href="<?php echo U('Content/alert?type=3');?>">修改</a></span></td>
																	<td></td>
																</tr>

																<tr>
																	<td class="center">会员介绍</td>
																	<td></td>
																	<td class="hidden-xs">
																		正常
																	</td>
																	<td class="hidden-480"> <span class="alter"><a href="<?php echo U('Content/alert?type=4');?>">修改</a></span> </td>
																	<td></td>
																</tr>
															</tbody>
														</table>
